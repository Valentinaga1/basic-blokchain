...
@app2.route('/mine_block', methods=['GET'])
def mine_block():
  """ Mining a new block """ 
...
@app2.route('/get_chain', methods=['GET'])
def get_chain():
...
@app2.route('/is_valid', methods = ['GET'])
def is_valid():
...
@app2.route('/add_transaction', methods = ['POST'])
def add_transaction():
...
@app2.route('/connect_node', methods = ['POST'])
def connect_node():
  json = request.get_json()
...
@app2.route('/replace_chain', methods = ['GET'])
def replace_chain():
